...
class Alerts {
    ...
    static func showAlertAction(preferredStyle: UIAlertController.Style = .alert, title: String = "", message: String = "", completeTitle: String = "Yes", cancelTitle: String = "Cancel", completeHandler:(() -> Void)? = nil, cancelHandler:(() -> Void)? = nil){
